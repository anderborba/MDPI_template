"""
Figure: Los Alamos InSAR phase – original and 512x512 crop
...
FULL_TIF = ("/home/aborba/MEGA/github/Chapter-Filtragem-em-Imagens-InSAR"
            "/Data/IMAGES/TIFF"
            "/alamos_35915_20008-000_20013-000_0007d_s01_L090HH_02_int_real_imag.tif")
OUT_PDF  = "../Figures/los_alamos_orig_and_crop_500.pdf"

# ── Crop coordinates (pixel indices in full image) ─────────────
ROW_W = 5000;  ROW_E = 5512
COL_H = 400;   COL_L = 912
...
STEP = 6   # downsample factor for full image display
