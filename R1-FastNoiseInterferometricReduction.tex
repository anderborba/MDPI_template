...
The common denoising infrastructure that allows us to compare the running times is an adaptive filtering framework that adjusts to local phase variability.
