...
We have concluded the Discussion section with the following paragraph: 
\begin{quote}
...
We performed the tests added the following paragraphs to Section~3.1:
\begin{quote}
...
We have restructured Section 2 (Materials and Methods) by consolidating several subsections. The section is now organized into Section 2.1 (Simulated Data), Section 2.2 (SAR Images), Section 2.3 (Statistical Models and Filters; new title). 
To maintain clarity, only Section 2.3 retains subsections, as dictated by the technical depth of its content. 
We moved the previous subsection ``Computational Resources" to the end of Section 2 to ensure a more logical progression of the methodology.

We modified figures 3, 4, 5, 6, and 7. 
Figures 3 and 4 were completely modified. 
Figures 5 and 6 were reorganized, mainly by changing the position of the legend and the font size, according to the MDPI author's manual. 
In figure 7, we increased its size in the text. 
