...
Thank you very much for your contribution. The authors fully agree with the suggestion, and we have made the following modification in the introduction:
...
While we appreciate the reviewer’s suggestion, we wish to emphasize that the novelty of this research does not stem from improved denoising over previous filters, but rather from the optimization of the underlying model. 
...
Thank you very much for your contribution. The authors fully agree with the suggestion, and we have made the following modification in Methodological Contributions section:
